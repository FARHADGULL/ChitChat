...
class GroupChatView extends StatelessWidget {
  ...
  PreferredSizeWidget? appBar() {
    return CustomAppBar(
      ...
      title: Text(
        messageViewModel.selectedGroupName.value.toString(),
      ...
      child: Container(
        ...
        child: Obx(() {
          return ListView.builder(
            ...
            //reverse: true,
            itemCount: messageViewModel.groupMessages.length,
            itemBuilder: (context, index) {
              final message = messageViewModel.groupMessages[index];
              //final senderName = 
              return Column(
                children: [
              ...
              Expanded(
                child: Container(
                  ...
                  child: TextField(
                      ...
                      onSubmitted: (value) {
                        messageViewModel.sendMessagesToGroup(
                    messageViewModel.messageController.text,
                    messageViewModel.selectedGroupId.value,
